...
export default async function S2Page({
  ...
  const strings: TalkStrings = {
    ...
    chatsTitle: t(locale, "s2.chats.title"),
    chatsNew: t(locale, "s2.chats.new"),
    chatsEmpty: t(locale, "s2.chats.empty"),
    chatsOpen: t(locale, "s2.chats.open"),
    chatsArchived: t(locale, "s2.chats.archived"),
    chatsOnDevice: t(locale, "s2.chats.onDevice"),
    jumpLatest: t(locale, "s2.chats.jumpLatest"),
    chatsDelete: t(locale, "s2.chats.delete"),
    chatsDeleteAll: t(locale, "s2.chats.deleteAll"),
    chatsClose: t(locale, "s2.primerClose"),
